...
class TownsControllerTest < ActionController::TestCase
  ...
  test "should create town" do
    assert_difference('Town.count') do
      post :create, town: { latitude: @town.latitude, longitude: @town.longitude, name: @town.name, zipcode: @town.zipcode }
    end
  ...
  test "should update town" do
    patch :update, id: @town, town: { latitude: @town.latitude, longitude: @town.longitude, name: @town.name, zipcode: @town.zipcode }
    assert_redirected_to town_path(assigns(:town))
  end
